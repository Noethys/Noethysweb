...
class Formulaire(FormulaireBase, forms.Form):
    ...
    collaborateurs = forms.ModelMultipleChoiceField(label="Collaborateurs", required=True, widget=Select2MultipleWidget({"lang": "fr", "data-minimum-input-length": 0, "data-width": "100%"}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["collaborateurs"].queryset = Collaborateur.objects.all().order_by("nom", "prenom")
