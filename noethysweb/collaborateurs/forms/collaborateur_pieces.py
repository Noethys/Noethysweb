...
from core.models import PieceCollaborateur, Collaborateur, TypePieceCollaborateur
...
class Formulaire(FormulaireBase, ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.form_id = 'collaborateur_pieces_form'
        ...
        # Définit le collaborateur associé
        collaborateur = Collaborateur.objects.get(pk=idcollaborateur)

        # Pièces à fournir
        self.liste_pieces_fournir = utils_pieces_manquantes.Get_pieces_manquantes(collaborateur=collaborateur)
        ...
        for type_piece in TypePieceCollaborateur.objects.all().order_by("nom"):
            self.liste_pieces_toutes.append({"label": type_piece.nom, "type_piece": type_piece})
        ...
        if self.instance.idpiece != None:
            ...
            for index, piece in enumerate(self.liste_pieces_fournir):
                if piece["type_piece"] == self.instance.type_piece:
