...
from collaborateurs.forms.importer_collaborateurs import Formulaire_parametres, Formulaire_colonne, DICT_TYPE_DONNEE
...
def Importer(request):
    ...
    from collaborateurs.utils import utils_importer_collaborateurs
    importer = utils_importer_collaborateurs.Importer(type_import=type_import, donnees_tableau=donnees_tableau, colonnes_affectees=colonnes_affectees, groupes=groupes)
...
class View(CustomView, TemplateView):
    menu_code = "importer_collaborateurs"
    template_name = "collaborateurs/importer_collaborateurs.html"

    def get_context_data(self, **kwargs):
        context = super(View, self).get_context_data(**kwargs)
        context["page_titre"] = "Importer des collaborateurs"
    ...
    def post(self, request, **kwargs):
        ...
        liste_type_donnee = DICT_TYPE_DONNEE["COLLABORATEURS"]
        ...
        context = {
            ...
            "form_type_colonne": Formulaire_colonne(request=self.request, type_import="COLLABORATEURS"),
        }
