...
urlpatterns = [
    ...
    path('consommations/traitement_automatique', secure_ajax(liste_attente.Traitement_automatique), name='liste_attente_traitement_automatique'),
    ...
    path('consommations/get_forfaits_disponibles', grille_forfaits.Get_forfaits_disponibles, name='ajax_get_forfaits_disponibles'),
    path('consommations/creation_forfait', grille_forfaits.Creation_forfait, name='ajax_creation_forfait'),
