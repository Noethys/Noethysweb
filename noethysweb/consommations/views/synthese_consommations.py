...
from core.utils import utils_dates, utils_infos_individus, utils_texte
...
class View(CustomView, TemplateView):
    ...
    def Get_resultats(self, parametres={}):
        ...
        for conso in consommations:
            ...
            if parametres["regroupement"] == "activite": regroupement = conso.activite.nom
            if parametres["regroupement"] == "groupe": regroupement = conso.groupe.nom
            ...
            if parametres["regroupement"] == "categorie_tarif": regroupement = conso.categorie_tarif.nom
            ...
            if parametres["regroupement"] == "famille": regroupement = dictInfosFamilles[conso.inscription.famille_id]["FAMILLE_NOM"]
            if parametres["regroupement"] == "individu": regroupement = dictInfosIndividus[conso.individu_id]["INDIVIDU_NOM_COMPLET"]
            if parametres["regroupement"] == "regime": regroupement = dictInfosFamilles[conso.inscription.famille_id]["FAMILLE_NOM_REGIME"]
            if parametres["regroupement"] == "caisse": regroupement = dictInfosFamilles[conso.inscription.famille_id]["FAMILLE_NOM_CAISSE"]
            ...
            if parametres["regroupement"] == "qf":
                regroupement = None
                qf = dictInfosFamilles[conso.inscription.famille_id]["FAMILLE_QF_ACTUEL_INT"]
            ...
            # Etiquettes
            # if parametres["regroupement"] == "etiquette":
            ...
            if parametres["regroupement"].startswith("question_") and "famille" in parametres["regroupement"]:
                regroupement = dictInfosFamilles[conso.inscription.famille_id]["QUESTION_%s" % parametres["regroupement"][17:]]
            ...
            if conso.prestation and conso.prestation.temps_facture:
            ...
            for regroupement in listeRegroupements:
                ...
                if (conso.unite_id in dictResultats[groupe]) == False:
                    dictResultats[groupe][conso.unite_id] = {}
                if (regroupement in dictResultats[groupe][conso.unite_id]) == False:
        ...
        if parametres["afficher_detail_groupe"] == True:
            ...
            # self.AppendCols(groupes.count() * liste_unites.count())
            index = 0
