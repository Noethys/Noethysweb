    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adresse', models.EmailField(help_text="Saisissez l'adresse mail utilisée.", max_length=300, verbose_name="Adresse d'envoi")),
                ('motdepasse', models.CharField(blank=True, help_text='Saisissez le mot de passe de la messagerie.', max_length=300, null=True, verbose_name='Mot de passe')),
                ('hote', models.CharField(blank=True, help_text="Saisissez le nom de l'hôte de la messagerie (Ex: smtp.orange.fr, smtp.gmail.com...).", max_length=300, null=True, verbose_name='Hôte')),
                ...
                ('defaut', models.BooleanField(default=False, verbose_name='Adresse par défaut')),
                ...
                ('utilisateur', models.CharField(blank=True, help_text="Saisissez le nom d'utilisateur (Souvent identique à l'adresse mail).", max_length=300, null=True, verbose_name='Utilisateur')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jours_scolaires', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[(0, 'Lundi'), (1, 'Mardi'), (2, 'Mercredi'), (3, 'Jeudi'), (4, 'Vendredi'), (5, 'Samedi'), (6, 'Dimanche')], max_length=100, null=True, verbose_name='Jours sur les périodes scolaires')),
                ('jours_vacances', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[(0, 'Lundi'), (1, 'Mardi'), (2, 'Mercredi'), (3, 'Jeudi'), (4, 'Vendredi'), (5, 'Samedi'), (6, 'Dimanche')], max_length=100, null=True, verbose_name='Jours sur les périodes de vacances')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nom', models.CharField(max_length=200, verbose_name='Nom')),
                ('numero', models.CharField(blank=True, max_length=200, null=True, verbose_name='Numéro')),
                ...
                ('code_ics', models.CharField(blank=True, max_length=200, null=True, verbose_name='Code ICS')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tel_domicile', models.CharField(blank=True, max_length=100, null=True, verbose_name='Tél domicile')),
                ('tel_mobile', models.CharField(blank=True, max_length=100, null=True, verbose_name='Tél portable')),
                ('mail', models.EmailField(blank=True, max_length=300, null=True, verbose_name='Email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adresse', models.EmailField(blank=True, max_length=300, null=True, verbose_name='Email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_creation', models.DateTimeField(auto_now_add=True, verbose_name='Date de création')),
                ('num_allocataire', models.CharField(blank=True, max_length=100, null=True, verbose_name="Numéro d'allocataire")),
                ...
                ('cp_resid', models.CharField(blank=True, max_length=50, null=True, verbose_name='Code postal')),
                ('ville_resid', models.CharField(blank=True, max_length=200, null=True, verbose_name='Ville')),
                ('mail', models.EmailField(blank=True, max_length=300, null=True, verbose_name='Email favori')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cp_naiss', models.CharField(blank=True, max_length=50, null=True, verbose_name='Code postal')),
                ('ville_naiss', models.CharField(blank=True, max_length=200, null=True, verbose_name='Ville')),
                ...
                ('employeur', models.CharField(blank=True, max_length=200, null=True, verbose_name='Employeur')),
                ('travail_tel', models.CharField(blank=True, max_length=100, null=True, verbose_name='Téléphone pro.')),
                ('travail_fax', models.CharField(blank=True, max_length=100, null=True, verbose_name='Fax pro.')),
                ('travail_mail', models.EmailField(blank=True, max_length=300, null=True, verbose_name='Email pro.')),
                ('tel_domicile', models.CharField(blank=True, max_length=100, null=True, verbose_name='Tél domicile')),
                ('tel_mobile', models.CharField(blank=True, max_length=100, null=True, verbose_name='Tél portable')),
                ('tel_fax', models.CharField(blank=True, max_length=100, null=True, verbose_name='Fax personnel')),
                ('mail', models.EmailField(blank=True, max_length=300, null=True, verbose_name='Email personnel')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='Mémo')),
                ('date_creation', models.DateTimeField(auto_now_add=True, verbose_name='Date de création')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('individu_rue', models.CharField(blank=True, max_length=200, null=True, verbose_name='Rue')),
                ('individu_cp', models.CharField(blank=True, max_length=50, null=True, verbose_name='Code postal')),
                ('individu_ville', models.CharField(blank=True, max_length=200, null=True, verbose_name='Ville')),
        ...
        migrations.CreateModel(
            name='PortailChamp',
            fields=[
                ('ichamp', models.AutoField(db_column='IDchamp', primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('representant', models.CharField(choices=[('AFFICHER', 'Afficher'), ('MASQUER', 'Masquer')], default='AFFICHER', max_length=100, verbose_name='Représentant')),
                ('enfant', models.CharField(choices=[('AFFICHER', 'Afficher'), ('MASQUER', 'Masquer')], default='AFFICHER', max_length=100, verbose_name='Enfant')),
                ('contact', models.CharField(choices=[('AFFICHER', 'Afficher'), ('MASQUER', 'Masquer')], default='AFFICHER', max_length=100, verbose_name='Contact')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.activite', verbose_name='Activité')),
                ('caisses', models.ManyToManyField(blank=True, to='core.Caisse', verbose_name='Caisses')),
                ('categories_tarifs', models.ManyToManyField(to='core.CategorieTarif', verbose_name='Catégories de tarifs')),
            ],
            options={
                'verbose_name': 'tarif',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.activite', verbose_name='Activité')),
                ('unites', models.ManyToManyField(to='core.Unite', verbose_name='Unités associées')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='tarif',
            name='cotisations',
            field=models.ManyToManyField(blank=True, to='core.TypeCotisation', verbose_name='Cotisations'),
        ),
        migrations.AddField(
            model_name='tarif',
            name='evenement',
        ...
        migrations.AddField(
            model_name='tarif',
            name='groupes',
            field=models.ManyToManyField(blank=True, to='core.Groupe', verbose_name='Groupes'),
        ),
        migrations.AddField(
            model_name='tarif',
            name='nom_tarif',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_debut', models.DateField(verbose_name='Date de début')),
                ('date_fin', models.DateField(verbose_name='Date de fin')),
                ('quotient', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=10, null=True, verbose_name='Quotient')),
                ('revenu', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=10, null=True, verbose_name='Revenu')),
                ('observations', models.TextField(blank=True, null=True, verbose_name='Observations')),
                ('famille', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.famille', verbose_name='Famille')),
        ...
        migrations.CreateModel(
            name='ProblemeSante',
            fields=[
                ('idprobleme', models.AutoField(db_column='IDprobleme', primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activite', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.activite', verbose_name='Activité')),
                ('categories', models.ManyToManyField(blank=True, related_name='categories_periode', to='core.CategorieCompteInternet', verbose_name='Sélection de catégories')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_debut', models.DateField(blank=True, null=True, verbose_name='Date de début')),
                ('date_fin', models.DateField(blank=True, null=True, verbose_name='Date de fin')),
                ('document', models.FileField(blank=True, null=True, upload_to=core.models.get_uuid_path, verbose_name='Document')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fichier', models.FileField(upload_to=core.models.get_uuid_path, verbose_name='Fichier')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to='core.ListeDiffusion'),
        ),
        migrations.AddField(
            model_name='individu',
            name='maladies',
        ...
        migrations.AddField(
            model_name='ecole',
            name='secteurs',
            field=models.ManyToManyField(blank=True, to='core.Secteur'),
        ),
        migrations.CreateModel(
            name='Devis',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tel_domicile', models.CharField(blank=True, max_length=100, null=True, verbose_name='Tél domicile')),
                ('tel_mobile', models.CharField(blank=True, max_length=100, null=True, verbose_name='Tél portable')),
                ('tel_travail', models.CharField(blank=True, max_length=100, null=True, verbose_name='Tél travail')),
                ('mail', models.EmailField(blank=True, max_length=300, null=True, verbose_name='Email')),
                ('observations', models.TextField(blank=True, null=True, verbose_name='Observations')),
                ('lien', models.CharField(max_length=200, verbose_name="Lien avec l'individu")),
        ...
        migrations.AddField(
            model_name='classe',
            name='niveaux',
            field=models.ManyToManyField(to='core.NiveauScolaire'),
        ),
        migrations.AddField(
            model_name='caisse',
            name='regime',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_contrat', models.CharField(max_length=200, verbose_name='N° de contrat')),
                ('date_debut', models.DateField(verbose_name='Date de début')),
                ('date_fin', models.DateField(blank=True, null=True, verbose_name='Date de fin')),
        ...
        migrations.AddField(
            ...
            name='structure',
            field=models.ForeignKey(blank=True, help_text='Choisissez si cette adresse est accessible par une structure spécifique ou par toutes les structures.', null=True, on_delete=django.db.models.deletion.PROTECT, to='core.structure', verbose_name='Structure'),
        ),
        migrations.AddField(
            model_name='activite',
            name='cotisations',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to='core.TypeGroupeActivite'),
        ),
        migrations.AddField(
            model_name='activite',
            name='pieces',
