...
class Individu(models.Model):
    ...
    cp_naiss = models.CharField(verbose_name="Code postal", max_length=50, blank=True, null=True)
    ville_naiss = models.CharField(verbose_name="Ville", max_length=200, blank=True, null=True)
    ...
    travail_fax = models.CharField(verbose_name="Fax pro.", max_length=100, blank=True, null=True)
    travail_mail = models.EmailField(verbose_name="Email pro.", max_length=300, blank=True, null=True)
...
class Quotient(models.Model):
    ...
    date_debut = models.DateField(verbose_name="Date de début")
    date_fin = models.DateField(verbose_name="Date de fin")
    quotient = models.DecimalField(verbose_name="Quotient", max_digits=10, decimal_places=2, default=0.0, blank=True, null=True)
...
class Destinataire(models.Model):
    ...
    adresse = models.EmailField(verbose_name="Email", max_length=300, blank=True, null=True)
