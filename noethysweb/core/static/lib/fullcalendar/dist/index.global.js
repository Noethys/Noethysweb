    ...
    function TimeColsAxisCell(props) {
        ...
        return (h(ViewContextType.Consumer, null, (context) => {
            ...
            return (h(ContentContainer, { elTag: "td", elClasses: classNames, elAttrs: {
                ...
                }, renderProps: renderProps, generatorName: "slotLabelContent", customGenerator: options.slotLabelContent, defaultGenerator: renderInnerContent$3, classNameGenerator: options.slotLabelClassNames, didMount: options.slotLabelDidMount, willUnmount: options.slotLabelWillUnmount }, (InnerContent) => (h("div", { className: "fc-timegrid-slot-label-frame fc-scrollgrid-shrink-frame" },
    ...
    */
    ...
    class TimelineHeaderTh extends BaseComponent {
        ...
        render() {
            ...
            return (h(ContentContainer, { elTag: "th", elClasses: [
                ...
                }, renderProps: renderProps, generatorName: "slotLabelContent", customGenerator: options.slotLabelContent, defaultGenerator: renderInnerContent$1, classNameGenerator: options.slotLabelClassNames, didMount: options.slotLabelDidMount, willUnmount: options.slotLabelWillUnmount }, (InnerContent) => (h("div", { className: "fc-timeline-slot-frame", style: { height: props.rowInnerHeight } },
                h(InnerContent, { elTag: "a", elClasses: [
    ...
    class TimelineSlatCell extends BaseComponent {
        render() {
            ...
            return (h(ContentContainer, { elTag: "td", elRef: props.elRef, elClasses: [
                ...
                }, renderProps: renderProps, generatorName: "slotLaneContent", customGenerator: options.slotLaneContent, classNameGenerator: options.slotLaneClassNames, didMount: options.slotLaneDidMount, willUnmount: options.slotLaneWillUnmount }, (InnerContent) => (h(InnerContent, { elTag: "div" }))));
        }
    }
    ...
    class TimelineView extends DateComponent {
        ...
        render() {
            ...
            return (h(ViewContainer, { elClasses: [
                    'fc-timeline',
    ...
    class SpreadsheetIndividualCell extends BaseComponent {
        ...
        render() {
            ...
            return (h(ContentContainer, { elTag: "td", elClasses: [
                ...
                }, renderProps: renderProps, generatorName: colSpec.isMain ? 'resourceLabelContent' : undefined, customGenerator: colSpec.cellContent, defaultGenerator: renderResourceInner, classNameGenerator: colSpec.cellClassNames, didMount: colSpec.cellDidMount, willUnmount: colSpec.cellWillUnmount }, (InnerContent) => (h("div", { className: "fc-datagrid-cell-frame", style: { height: props.innerHeight } },
    ...
    class SpreadsheetGroupCell extends BaseComponent {
        render() {
            ...
            return (h(ContentContainer, { elTag: "td", elClasses: [
                ...
                }, renderProps: renderProps, generatorName: "resourceGroupLabelContent", customGenerator: colSpec.cellContent, defaultGenerator: renderGroupInner, classNameGenerator: colSpec.cellClassNames, didMount: colSpec.cellDidMount, willUnmount: colSpec.cellWillUnmount }, (InnerContent) => (h("div", { className: "fc-datagrid-cell-frame fc-datagrid-cell-frame-liquid" },
    ...
    class SpreadsheetHeader extends BaseComponent {
        ...
        render() {
            ...
            rowNodes.push(h("tr", { key: "row", role: "row" }, colSpecs.map((colSpec, i) => {
                ...
                return (h(ContentContainer, { key: i, elTag: "th", elClasses: ['fc-datagrid-cell'], elAttrs: { role: 'columnheader' }, renderProps: renderProps, generatorName: "resourceAreaHeaderContent", customGenerator: colSpec.headerContent, defaultGenerator: colSpec.headerDefault, classNameGenerator: colSpec.headerClassNames, didMount: colSpec.headerDidMount, willUnmount: colSpec.headerWillUnmount }, (InnerContent) => (h("div", { className: "fc-datagrid-cell-frame", style: { height: rowInnerHeight } },
                    h("div", { className: "fc-datagrid-cell-cushion fc-scrollgrid-sync-inner" },
        ...
        render() {
            ...
            return (h("tr", { ref: props.elRef },
                h(ContentContainer, { elTag: "td", elRef: props.elRef, elClasses: [
                        ...
                        'fc-resource-group',
                        context.theme.getClass('tableCellShaded'),
                    ], renderProps: renderProps, generatorName: "resourceGroupLaneContent", customGenerator: renderHooks.laneContent, classNameGenerator: renderHooks.laneClassNames, didMount: renderHooks.laneDidMount, willUnmount: renderHooks.laneWillUnmount }, (InnerContainer) => (h(InnerContainer, { elTag: "div", elStyle: { height: props.innerHeight } })))));
        }
    }
