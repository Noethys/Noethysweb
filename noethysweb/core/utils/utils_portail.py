...
LISTE_PARAMETRES = [
    ...
    Parametre(code="connexion_creation_compte", label="Autoriser la création autonome de comptes utilisateurs", type="boolean", valeur=False, help_text="En activant cette option, vous autorisez un usager à créer une fiche famille et les fiches individuelles directement sur le portail. Nécessite une adresse d'expédition active ci-dessus pour l'envoi de l'email d'activation."),
