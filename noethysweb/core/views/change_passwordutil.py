...
class MyPasswordChangeView(ClassCommuneLogin, auth_views.PasswordChangeView):
    ...
    def form_valid(self, form):
        ...
        if "secquest" in form.cleaned_data:
            if not utils_secquest.Check_secquest(utilisateur=self.request.user.utilisateur, reponse=form.cleaned_data["secquest"]):
        ...
        utilisateur.save()
        utilisateur.utilisateurs.internet_mdp = "*****"
        utilisateur.utilisateurs.save()
