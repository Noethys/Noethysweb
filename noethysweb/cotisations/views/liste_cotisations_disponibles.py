...
class Liste(Page, crud.Liste):
    ...
    class datatable_class(MyDatatable):
        filtres = ["igenerique:individu", "fgenerique:famille", "idcotisation", "date_saisie", "date_creation_carte", "numero", "date_debut", "date_fin", "observations", "type_cotisation__nom", "unite_cotisation__nom"]
