...
VALEURS_DEFAUT = {
    "memoriser_parametres": False, "affichage_solde": "actuel", "afficher_impayes": True, "integrer_impayes": True, "afficher_coupon_reponse": True, "afficher_messages": True,
    ...
    "taille_texte_individu": 6, "taille_texte_activite": 6, "taille_texte_noms_colonnes": 5, "taille_texte_prestation": 7, "taille_texte_messages": 7,
...
class Formulaire(FormulaireBase, forms.Form):
    ...
    affichage_prestations = forms.ChoiceField(label="Affichage des prestations", choices=[("0", "Détaillé"), ("1", "Regroupement par label"), ("2", "Regroupement par label et par montant unitaire")], initial=VALEURS_DEFAUT["affichage_prestations"], required=True)
    ...
    def clean(self):
        if self.cleaned_data["memoriser_parametres"]:
            ...
            del parametres["memoriser_parametres"]
            utils_parametres.Set_categorie(categorie="impression_facture", parametres=parametres)
