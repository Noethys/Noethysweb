...
class Formulaire(FormulaireBase, forms.Form):
    ...
    texte_titre = forms.CharField(label="Titre du document", initial="Facture", required=True)
    ...
    texte_prestations_anterieures = forms.CharField(label="Texte d'information", initial="Des prestations antérieures ont été reportées sur cette facture.", required=True)
