...
from facturation.forms.export_ecritures_ebp import Formulaire
from facturation.utils import utils_export_ebp
...
def Exporter(request):
    ...
    # Exporter
    export = utils_export_ebp.Exporter(request=request, options=options)
...
class View(CustomView, TemplateView):
    menu_code = "export_ecritures_ebp"
    template_name = "facturation/export_ecritures_ebp.html"

    def get_context_data(self, **kwargs):
        context = super(View, self).get_context_data(**kwargs)
        context['page_titre'] = "Export des écritures comptables"
        context['box_titre'] = "Export des écritures vers EBP Compta"
