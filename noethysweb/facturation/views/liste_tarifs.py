...
def Get_html_tarifs_activite(activite=None):
    ...
    for tarif in tarifs:
        texte_categories = utils_texte.Convert_liste_to_texte_virgules(
            [categorie.nom for categorie in tarif.categories_tarifs.all()])
...
class View(CustomView, TemplateView):
    ...
    def Get_resultats(self, parametres={}):
        return Get_html_tarifs_activite(activite=parametres["activite"])
