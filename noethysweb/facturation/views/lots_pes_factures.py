...
class Liste(crud.Page, crud.Liste):
    ...
    class datatable_class(MyDatatable):
        filtres = ["fpresent:pk", "fscolarise:pk", 'fprelevement_actif:famille__mandats__actif', 'idfacture', 'date_edition', 'prefixe', 'numero', 'date_debut', 'date_fin', 'total', 'solde', 'solde_actuel', 'lot__nom']
