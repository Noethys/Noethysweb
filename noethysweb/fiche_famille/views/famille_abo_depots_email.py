...
from fiche_famille.forms.famille_abo_depots_email import Formulaire
...
class Modifier(Onglet, crud.Modifier):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['box_titre'] = "Envoi des avis d'encaissement par Email"
        context['box_introduction'] = "Vous pouvez activer ici le service d'envoi des avis d'encaissement par Email. Sélectionnez une ou plusieurs adresses de destination."
