...
class Formulaire(FormulaireBase, forms.Form):
    ...
    theme = forms.ChoiceField(label="Thème graphique", choices=[("feuille", "Feuille d'été"), ("cailloux", "Plage de cailloux"), ("gouttes", "Gouttes d'eau"), ("lignes", "Ballet de lignes"), ("mongolfieres", "Montgolfières"), ("mosaique", "Mosaïque")], initial="feuille", required=False)
