...
from individus.forms.edition_contacts import Formulaire
...
def Generer_pdf(request):
    ...
    # Création du PDF
    from individus.utils import utils_impression_contacts
    impression = utils_impression_contacts.Impression(titre="Edition des contacts", dict_donnees=options)
...
class View(CustomView, TemplateView):
    menu_code = "edition_contacts"
    template_name = "individus/edition_contacts.html"

    def get_context_data(self, **kwargs):
        context = super(View, self).get_context_data(**kwargs)
        context['page_titre'] = "Edition des contacts"
        context['box_titre'] = "Edition des contacts"
