...
class Liste(Page, crud.Liste):
    ...
    def get_queryset(self):
        return SMS.objects.filter(self.Get_filtres("Q")).annotate(nbre_destinataires=Count("destinataires"))
    ...
    class datatable_class(MyDatatable):
        ...
        class Meta:
            ...
            columns = ['check', 'idsms', 'date_creation', 'objet', 'nbre_destinataires']
