...
class Formulaire(FormulaireBase, ModelForm):
    ...
    # Groupes d'activités
    groupes_activites = forms.ModelMultipleChoiceField(label="Groupes d'activités", widget=Select2MultipleWidget({"lang":"fr"}), queryset=TypeGroupeActivite.objects.all(), required=False)
