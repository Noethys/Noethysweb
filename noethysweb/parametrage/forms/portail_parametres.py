...
LISTE_RUBRIQUES = [
    ...
    ("Page de la facturation", ["facturation_afficher_page", "facturation_afficher_solde_famille", "facturation_afficher_numero_facture", "facturation_afficher_solde_facture",
