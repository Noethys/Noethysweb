...
from core.models import QuestionnaireGroupe
...
class Formulaire(FormulaireBase, ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.form_id = 'questionnaires_groupes_form'
        ...
        if self.instance.ordre == None:
            max = QuestionnaireGroupe.objects.filter(categorie=categorie).aggregate(Max('ordre'))['ordre__max']
            if max == None:
                max = 0
