...
urlpatterns = [
    ...
    path('parametrage/activites/evenements/modifier_plusieurs/<int:idactivite>/<str:listepk>', activites_evenements.Modifier_plusieurs.as_view(), name='activites_evenements_modifier_plusieurs'),
