...
from parametrage.forms.modeles_emails import Formulaire
...
class Page(crud.Page):
    model = ModeleEmail
    url_liste = "modeles_emails_liste"
    url_ajouter = "modeles_emails_ajouter"
    url_modifier = "modeles_emails_modifier"
    url_supprimer = "modeles_emails_supprimer"
    url_dupliquer = "modeles_emails_dupliquer"
    ...
    objet_singulier = "un modèle d'email"
    objet_pluriel = "des modèles d'emails"
    ...
    def get_context_data(self, **kwargs):
        ...
        context['liste_categories'] = CATEGORIES_MODELES_EMAILS
...
class Supprimer(Page, crud.Supprimer):
    ...
    #         if len(self.model.objects.filter(categorie=self.object.categorie).filter(defaut=True)) == 0:
    #             objet = self.model.objects.filter(categorie=self.object.categorie).first()
    #             if objet:
    #                 objet.defaut = True
    #                 objet.save()
    #     return reponse
