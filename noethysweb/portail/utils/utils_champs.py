...
LISTE_CHAMPS = [
    ...
    Champ(page="individu_coords", code="tel_domicile", representant="AFFICHER", enfant="AFFICHER", contact="AFFICHER"),
    Champ(page="individu_coords", code="tel_mobile", representant="AFFICHER", enfant="AFFICHER", contact="AFFICHER"),
    Champ(page="individu_coords", code="mail", representant="AFFICHER", enfant="AFFICHER", contact="AFFICHER"),
